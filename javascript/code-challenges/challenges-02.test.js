...
const addQuestion = (arr) => {
  // Solution code here...
  let newArray = arr.map(strings => strings + '?');
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.forEach(integer => newArray.push(Math.pow(2, integer)));
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let newArray = arr.map(integer => Math.pow(2, integer));
...
const charCode = (arr) => {
  let newArray = arr.map(someletters => someletters.charCodeAt(0));
