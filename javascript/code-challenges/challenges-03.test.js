...
const containsAnd = (arr) => {
  // Solution code here...
  let newArray = arr.filter(strings => strings.includes('and'));
...
const oddValues = (arr) => {
  // Solution code here...
  let newArray = arr.filter(numbers => numbers % 2 !== 0);
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newArray = arr.filter(arrValues => !forbiddenValues.includes(arrValues));
